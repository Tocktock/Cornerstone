...
Strict checks are intentionally local/manual because they depend on current VS2
reusable proof state, Docker/network support, and a clean review workspace:
