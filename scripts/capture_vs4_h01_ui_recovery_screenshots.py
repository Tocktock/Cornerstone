...
DETAIL_ROUTES = [
    {"name": "artifact-detail-desktop", "kind": "artifacts", "id_key": "artifact_id", "surface": "artifact-detail", "required": ["Source inspection workspace", "Detail path", "Back to saved sources", "Original source", "Original artifact preview", "Source metadata", "Artifact inspection summary", "Preview mode", "Details", "Tags", "Source state", "Summary", "Extracted keywords", "Provenance"]},
