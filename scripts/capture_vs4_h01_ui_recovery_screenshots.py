...
DESKTOP_ROUTES = [
    {"name": "home-desktop", "route": "/", "surface": "home", "required": ["Drop anything, or ask what we know", "Drag and drop files or paste notes here", "Browse files", "Ask the workspace", "Recent items", "Knowledge states", "Suggested next steps", "Recent activity"]},
    {"name": "search-desktop", "route": "/search?q=vendor%20renewal", "surface": "search", "required": ["Search command center", "Search the workspace", "Type filters", "Sort by: keyword match", "Current search controls", "Search mode: local keyword", "Result receipt", "Open result", "What we found", "Suggested follow-ups"]},
    {"name": "artifacts-desktop", "route": "/artifacts", "surface": "artifacts", "required": ["Saved sources", "Collection summary", "Source register"]},
    {"name": "briefs-desktop", "route": "/briefs", "surface": "briefs", "required": ["Brief workspace", "Decision queue", "Brief reading queue", "Review lanes", "Brief queue", "Source coverage", "Use next", "Brief posture"]},
    {"name": "claims-desktop", "route": "/claims", "surface": "claims", "required": ["Claims that need source support", "Decision queue", "Claim review lanes", "Evidence-backed lane", "Claim review queue", "Review posture"]},
    {"name": "actions-desktop", "route": "/actions", "surface": "actions", "required": ["Action drafts", "Decision queue", "Action approval lanes", "Approval lane", "Action preview queue", "Dry-run posture"]},
...
DETAIL_ROUTES = [
    ...
    {"name": "brief-detail-desktop", "kind": "briefs", "id_key": "brief_id", "surface": "brief-detail", "required": ["Brief reading workspace", "Detail path", "Back to briefs", "Open audit trail", "Decision snapshot", "What we found", "Findings with citations", "What this brief cannot confirm", "Suggested next steps", "Sources used", "Citation disclosure", "Source snippet", "Full provenance", "Audit trail", "Use this brief"]},
    {
        ...
        "required": ["Detail path", "Back to claims", "Open inbox", "Claim review summary", "Claim statement", "Supporting evidence", "Review controls", "Decision gate", "Source support", "Impacted objects", "Related frameworks", "Saved locally"],
    },
