...
DESKTOP_ROUTES = [
    ...
    {"name": "search-desktop", "route": "/search?q=vendor%20renewal", "surface": "search", "required": ["Search the workspace", "Current search controls", "Search mode: local keyword", "Result receipt", "Open result", "What we found", "Suggested follow-ups"]},
...
DETAIL_ROUTES = [
    {"name": "artifact-detail-desktop", "kind": "artifacts", "id_key": "artifact_id", "surface": "artifact-detail", "required": ["Source inspection workspace", "Detail path", "Back to saved sources", "Original source", "Original artifact preview", "Source metadata", "Source state", "Summary", "Extracted keywords", "Provenance"]},
