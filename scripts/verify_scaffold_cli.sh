...
grep -q '"brief_status": "extractive_fallback"' "$brief_json" || fail "vs0-briefing missing fallback-safe brief"
grep -q '"brief_trust_label": "extractive_fallback"' "$brief_json" || fail "vs0-briefing missing fallback trust label"
grep -q '"brief_presented_as_fact": false' "$brief_json" || fail "vs0-briefing presented fallback brief as fact"
grep -q '"brief_evidence_backed_label": 0' "$brief_json" || fail "vs0-briefing overclaimed evidence-backed brief"
