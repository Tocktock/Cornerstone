...
Date: 2026-07-04T21:57:22.864981Z
...
- `output/playwright/vs4-h01-ui-recovery/screenshots/brief-detail-desktop.png`: PASS / `/briefs/brief_280da94dad89dd29?view=html` / desktop
- `output/playwright/vs4-h01-ui-recovery/screenshots/claim-detail-desktop.png`: PASS / `/claims/claim_cc5e1af3667a985b?view=html` / desktop
- `output/playwright/vs4-h01-ui-recovery/screenshots/action-detail-desktop.png`: PASS / `/actions/action_032eae6174eafd46?view=html` / desktop
...
- `output/playwright/vs4-h01-ui-recovery/screenshots/brief-detail-mobile.png`: PASS / `/briefs/brief_280da94dad89dd29?view=html` / mobile
- `output/playwright/vs4-h01-ui-recovery/screenshots/action-detail-mobile.png`: PASS / `/actions/action_032eae6174eafd46?view=html` / mobile
