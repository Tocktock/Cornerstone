...
Date: 2026-07-05T02:15:55.551467Z
...
- `output/playwright/vs4-h01-ui-recovery/screenshots/brief-detail-desktop.png`: PASS / `/briefs/brief_1b9c8779dce057ec?view=html` / desktop
- `output/playwright/vs4-h01-ui-recovery/screenshots/claim-detail-desktop.png`: PASS / `/claims/claim_acbebef4a7a71be5?view=html` / desktop
- `output/playwright/vs4-h01-ui-recovery/screenshots/action-detail-desktop.png`: PASS / `/actions/action_24fd7cd8eeff242c?view=html` / desktop
...
- `output/playwright/vs4-h01-ui-recovery/screenshots/brief-detail-mobile.png`: PASS / `/briefs/brief_1b9c8779dce057ec?view=html` / mobile
- `output/playwright/vs4-h01-ui-recovery/screenshots/claim-detail-mobile.png`: PASS / `/claims/claim_acbebef4a7a71be5?view=html` / mobile
- `output/playwright/vs4-h01-ui-recovery/screenshots/action-detail-mobile.png`: PASS / `/actions/action_24fd7cd8eeff242c?view=html` / mobile
