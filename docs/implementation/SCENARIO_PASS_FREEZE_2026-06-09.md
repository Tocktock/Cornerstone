...
- [x] Build native `cornerstone` CLI scaffold for version/health/ready/scenario commands.
- [x] Add deterministic fixtures and validators.
- [x] Add local `local_test` model provider.
