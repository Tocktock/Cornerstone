...
- Read commands: `cornerstone workspace current --json`, `cornerstone brief show <brief_id> --json`, `cornerstone memory list --workspace <workspace_id> --json`, `cornerstone action show <action_id> --json`, `cornerstone audit list --workspace <workspace_id> --json`.
- Create/update commands: `cornerstone artifact add <path> --json`, `cornerstone brief create --from-artifact <artifact_id> --json`, `cornerstone claim create --brief <brief_id> --json`, `cornerstone memory propose --from-brief <brief_id> --json`, `cornerstone action create --from-claim <claim_id> --json`.
