...
The newer product goal defines CornerStone as an evidence-first operational intelligence platform for personal and organizational knowledge. The V2 full handoff installs the full MUST-PASS scenario standard and a strict VS-0 implementation subset.
...
3. `docs/scenario-contracts/SCENARIO_MATRIX_FULL.md` - generated 206-scenario index.
4. `docs/sot/03_TECHNICAL_ARCHITECTURE_DEFAULTS.md` - compatible technical defaults only.
5. `docs/scenario-contracts/VS0_IMPLEMENTATION_CONTRACT.md` - first implementation freeze.

Archive or preserve the old `project-sot.md` as superseded historical evidence. Do not allow it to claim current product authority.
...
- Future agents have a full 206-scenario standard rather than a summary.
