...
# audit_evidence.clean_audit_event_count: 5
# audit_evidence.event_types: artifact.ingested, artifact.read, search.snapshot.created, evidence_bundle.created, claim.draft.created
