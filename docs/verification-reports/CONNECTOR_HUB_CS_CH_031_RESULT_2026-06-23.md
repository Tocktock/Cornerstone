...
- Testability: the focused verifier command is `cornerstone scenario verify connector-contract-adapter --scenario CS-CH-031 --json`; the expected method is `Fixture integration test and human live gate`.
