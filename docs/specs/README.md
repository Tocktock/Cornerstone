...
The truth target is the current working tree. Specs should reflect the live product behavior and intended near-term direction represented in source and accepted decisions, even if the worktree is ahead of the last clean commit.
