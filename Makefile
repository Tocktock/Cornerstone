...
verify-vs4-product-alpha-shell:
	PATH="$(PWD):$$PATH" cornerstone scenario verify vs4-product-alpha-ui-daily-loop --scenario VS4-GATE-001 --scenario VS4-UI-001 --scenario VS4-UI-012 --scenario VS4-UI-015 --scenario VS4-UI-016 --scenario VS4-REG-003 --scenario VS4-REG-006 --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-001-product-shell.json
	PATH="$(PWD):$$PATH" cornerstone scenario gate reports/scenario/vs4-product-alpha-ui-daily-loop-slice-001-product-shell.json --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-001-product-shell-gate.json

verify-vs4-product-alpha-brief-detail:
	PATH="$(PWD):$$PATH" cornerstone scenario verify vs4-product-alpha-ui-daily-loop --scenario VS4-UI-002 --scenario VS4-UI-003 --scenario VS4-UI-004 --scenario VS4-UI-005 --scenario VS4-UI-006 --scenario VS4-UI-007 --scenario VS4-UI-008 --scenario VS4-UI-009 --scenario VS4-UI-010 --scenario VS4-UI-011 --scenario VS4-REF-002 --scenario VS4-REG-004 --scenario VS4-REG-005 --scenario VS4-REG-007 --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-002-brief-detail.json
	PATH="$(PWD):$$PATH" cornerstone scenario gate reports/scenario/vs4-product-alpha-ui-daily-loop-slice-002-brief-detail.json --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-002-brief-detail-gate.json

verify-vs4-product-alpha-slice-003:
	PATH="$(PWD):$$PATH" cornerstone scenario verify vs4-product-alpha-ui-daily-loop --scenario VS4-UI-013 --scenario VS4-UI-014 --scenario VS4-STATE-001 --scenario VS4-REF-001 --scenario VS4-REG-001 --scenario VS4-REG-002 --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-003-ask-packs-states-regression.json
	PATH="$(PWD):$$PATH" cornerstone scenario gate reports/scenario/vs4-product-alpha-ui-daily-loop-slice-003-ask-packs-states-regression.json --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-003-ask-packs-states-regression-gate.json
...
verify-vs4-product-alpha-ask-injection-boundary:
	PATH="$(PWD):$$PATH" cornerstone scenario verify vs4-product-alpha-ui-daily-loop --scenario VS4-GATE-001 --scenario VS4-UI-007 --scenario VS4-UI-009 --scenario VS4-UI-011 --scenario VS4-UI-013 --scenario VS4-REG-004 --scenario VS4-REG-007 --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-010-ask-injection-boundary.json
	PATH="$(PWD):$$PATH" cornerstone scenario gate reports/scenario/vs4-product-alpha-ui-daily-loop-slice-010-ask-injection-boundary.json --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-010-ask-injection-boundary-gate.json

verify-vs4-product-alpha-ops-inbox-triage:
	PATH="$(PWD):$$PATH" cornerstone scenario verify vs4-product-alpha-ui-daily-loop --scenario VS4-GATE-001 --scenario VS4-UI-001 --scenario VS4-UI-012 --scenario VS4-UI-015 --scenario VS4-UI-016 --scenario VS4-STATE-001 --scenario VS4-REF-001 --scenario VS4-REG-003 --scenario VS4-REG-006 --scenario VS4-REG-007 --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-011-ops-inbox-triage-detail.json
	PATH="$(PWD):$$PATH" cornerstone scenario gate reports/scenario/vs4-product-alpha-ui-daily-loop-slice-011-ops-inbox-triage-detail.json --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-011-ops-inbox-triage-detail-gate.json

verify-vs4-product-alpha-action-execution-boundary:
	PATH="$(PWD):$$PATH" cornerstone scenario verify vs4-product-alpha-ui-daily-loop --scenario VS4-GATE-001 --scenario VS4-UI-007 --scenario VS4-UI-009 --scenario VS4-UI-010 --scenario VS4-UI-011 --scenario VS4-REF-002 --scenario VS4-REG-003 --scenario VS4-REG-004 --scenario VS4-REG-007 --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-012-action-execution-boundary.json
	PATH="$(PWD):$$PATH" cornerstone scenario gate reports/scenario/vs4-product-alpha-ui-daily-loop-slice-012-action-execution-boundary.json --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-012-action-execution-boundary-gate.json

verify-vs4-product-alpha-desktop-overflow:
	PATH="$(PWD):$$PATH" cornerstone scenario verify vs4-product-alpha-ui-daily-loop --scenario VS4-GATE-001 --scenario VS4-UI-001 --scenario VS4-UI-004 --scenario VS4-UI-010 --scenario VS4-UI-011 --scenario VS4-REF-002 --scenario VS4-REG-003 --scenario VS4-REG-006 --scenario VS4-REG-007 --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-013-desktop-overflow-containment.json
	PATH="$(PWD):$$PATH" cornerstone scenario gate reports/scenario/vs4-product-alpha-ui-daily-loop-slice-013-desktop-overflow-containment.json --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-013-desktop-overflow-containment-gate.json

verify-vs4-product-alpha-human-review-handoff:
	PATH="$(PWD):$$PATH" cornerstone scenario verify vs4-product-alpha-ui-daily-loop --scenario VS4-GATE-001 --scenario VS4-UI-001 --scenario VS4-UI-012 --scenario VS4-UI-015 --scenario VS4-UI-016 --scenario VS4-STATE-001 --scenario VS4-REG-003 --scenario VS4-REG-005 --scenario VS4-REG-006 --scenario VS4-REG-007 --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-014-human-review-handoff.json
	PATH="$(PWD):$$PATH" cornerstone scenario gate reports/scenario/vs4-product-alpha-ui-daily-loop-slice-014-human-review-handoff.json --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-014-human-review-handoff-gate.json
...
verify-vs4-product-alpha-evidence-audit-detail:
	PATH="$(PWD):$$PATH" cornerstone scenario verify vs4-product-alpha-ui-daily-loop --scenario VS4-GATE-001 --scenario VS4-UI-005 --scenario VS4-UI-012 --scenario VS4-UI-016 --scenario VS4-STATE-001 --scenario VS4-REG-003 --scenario VS4-REG-006 --scenario VS4-REG-007 --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-016-evidence-audit-detail.json
	PATH="$(PWD):$$PATH" cornerstone scenario gate reports/scenario/vs4-product-alpha-ui-daily-loop-slice-016-evidence-audit-detail.json --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-016-evidence-audit-detail-gate.json

verify-vs4-product-alpha-user-drop-ask-source:
	PATH="$(PWD):$$PATH" cornerstone scenario verify vs4-product-alpha-ui-daily-loop --scenario VS4-GATE-001 --scenario VS4-UI-001 --scenario VS4-UI-002 --scenario VS4-UI-003 --scenario VS4-UI-004 --scenario VS4-UI-013 --scenario VS4-UI-016 --scenario VS4-REG-003 --scenario VS4-REG-004 --scenario VS4-REG-006 --scenario VS4-REG-007 --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-017-user-drop-ask-source.json
	PATH="$(PWD):$$PATH" cornerstone scenario gate reports/scenario/vs4-product-alpha-ui-daily-loop-slice-017-user-drop-ask-source.json --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-017-user-drop-ask-source-gate.json

verify-vs4-product-alpha-drop-ask-trust-boundary:
	PATH="$(PWD):$$PATH" cornerstone scenario verify vs4-product-alpha-ui-daily-loop --scenario VS4-GATE-001 --scenario VS4-UI-002 --scenario VS4-UI-007 --scenario VS4-UI-009 --scenario VS4-UI-011 --scenario VS4-UI-013 --scenario VS4-REG-003 --scenario VS4-REG-004 --scenario VS4-REG-007 --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-018-drop-ask-trust-boundary.json
	PATH="$(PWD):$$PATH" cornerstone scenario gate reports/scenario/vs4-product-alpha-ui-daily-loop-slice-018-drop-ask-trust-boundary.json --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-018-drop-ask-trust-boundary-gate.json

verify-vs4-product-alpha-interactive-ops-inbox:
	PATH="$(PWD):$$PATH" cornerstone scenario verify vs4-product-alpha-ui-daily-loop --scenario VS4-GATE-001 --scenario VS4-UI-001 --scenario VS4-UI-012 --scenario VS4-UI-013 --scenario VS4-UI-015 --scenario VS4-UI-016 --scenario VS4-STATE-001 --scenario VS4-REF-001 --scenario VS4-REG-003 --scenario VS4-REG-006 --scenario VS4-REG-007 --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-019-interactive-ops-inbox.json
	PATH="$(PWD):$$PATH" cornerstone scenario gate reports/scenario/vs4-product-alpha-ui-daily-loop-slice-019-interactive-ops-inbox.json --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-019-interactive-ops-inbox-gate.json

verify-vs4-product-alpha-runtime-backed-ops-inbox:
	PATH="$(PWD):$$PATH" cornerstone scenario verify vs4-product-alpha-ui-daily-loop --scenario VS4-GATE-001 --scenario VS4-UI-001 --scenario VS4-UI-008 --scenario VS4-UI-009 --scenario VS4-UI-012 --scenario VS4-UI-013 --scenario VS4-UI-015 --scenario VS4-UI-016 --scenario VS4-STATE-001 --scenario VS4-REF-001 --scenario VS4-REG-003 --scenario VS4-REG-004 --scenario VS4-REG-006 --scenario VS4-REG-007 --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-020-runtime-backed-ops-inbox.json
	PATH="$(PWD):$$PATH" cornerstone scenario gate reports/scenario/vs4-product-alpha-ui-daily-loop-slice-020-runtime-backed-ops-inbox.json --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-020-runtime-backed-ops-inbox-gate.json

verify-vs4-product-alpha-runtime-loop-coherence:
	PATH="$(PWD):$$PATH" cornerstone scenario verify vs4-product-alpha-ui-daily-loop --scenario VS4-GATE-001 --scenario VS4-UI-001 --scenario VS4-UI-008 --scenario VS4-UI-009 --scenario VS4-UI-010 --scenario VS4-UI-011 --scenario VS4-UI-012 --scenario VS4-UI-013 --scenario VS4-UI-016 --scenario VS4-STATE-001 --scenario VS4-REF-002 --scenario VS4-REG-003 --scenario VS4-REG-004 --scenario VS4-REG-005 --scenario VS4-REG-006 --scenario VS4-REG-007 --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-021-runtime-loop-coherence.json
	PATH="$(PWD):$$PATH" cornerstone scenario gate reports/scenario/vs4-product-alpha-ui-daily-loop-slice-021-runtime-loop-coherence.json --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-021-runtime-loop-coherence-gate.json

verify-vs4-product-alpha-return-to-work-lineage:
	PATH="$(PWD):$$PATH" cornerstone scenario verify vs4-product-alpha-ui-daily-loop --scenario VS4-GATE-001 --scenario VS4-UI-008 --scenario VS4-UI-009 --scenario VS4-UI-010 --scenario VS4-UI-011 --scenario VS4-UI-012 --scenario VS4-UI-013 --scenario VS4-UI-015 --scenario VS4-UI-016 --scenario VS4-STATE-001 --scenario VS4-REF-002 --scenario VS4-REG-003 --scenario VS4-REG-004 --scenario VS4-REG-005 --scenario VS4-REG-006 --scenario VS4-REG-007 --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-022-return-to-work-lineage.json
	PATH="$(PWD):$$PATH" cornerstone scenario gate reports/scenario/vs4-product-alpha-ui-daily-loop-slice-022-return-to-work-lineage.json --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-022-return-to-work-lineage-gate.json

verify-vs4-product-alpha-active-report-package-coherence:
	PATH="$(PWD):$$PATH" cornerstone scenario verify vs4-product-alpha-ui-daily-loop --scenario VS4-GATE-001 --scenario VS4-UI-012 --scenario VS4-UI-015 --scenario VS4-REG-003 --scenario VS4-REG-005 --scenario VS4-REG-007 --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-024-active-report-package-coherence.json
	PATH="$(PWD):$$PATH" cornerstone scenario gate reports/scenario/vs4-product-alpha-ui-daily-loop-slice-024-active-report-package-coherence.json --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-024-active-report-package-coherence-gate.json

verify-vs4-product-alpha-ops-inbox-journey-timeline:
	PATH="$(PWD):$$PATH" cornerstone scenario verify vs4-product-alpha-ui-daily-loop --scenario VS4-GATE-001 --scenario VS4-UI-001 --scenario VS4-UI-005 --scenario VS4-UI-006 --scenario VS4-UI-007 --scenario VS4-UI-008 --scenario VS4-UI-009 --scenario VS4-UI-010 --scenario VS4-UI-011 --scenario VS4-UI-012 --scenario VS4-UI-013 --scenario VS4-UI-015 --scenario VS4-UI-016 --scenario VS4-STATE-001 --scenario VS4-REF-001 --scenario VS4-REF-002 --scenario VS4-REG-003 --scenario VS4-REG-004 --scenario VS4-REG-005 --scenario VS4-REG-006 --scenario VS4-REG-007 --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-025-ops-inbox-journey-timeline.json
	PATH="$(PWD):$$PATH" cornerstone scenario gate reports/scenario/vs4-product-alpha-ui-daily-loop-slice-025-ops-inbox-journey-timeline.json --json --output reports/scenario/vs4-product-alpha-ui-daily-loop-slice-025-ops-inbox-journey-timeline-gate.json

verify-vs4-product-alpha-report-package-integrity: verify-vs4-product-alpha-return-to-work-lineage verify-vs4-product-alpha-active-report-package-coherence verify-vs4-product-alpha-ops-inbox-journey-timeline verify-vs4-product-alpha-human-package
