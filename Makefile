.PHONY: verify-docs verify-scenario-matrix verify-scaffold-cli verify-vs0-runtime verify-vs0-acceptance verify-vs0-evux verify-vs0-operator-ui verify-vs1-ontology verify-vs4-product-alpha-shell verify-vs4-product-alpha-brief-detail verify-vs4-product-alpha-slice-003 verify-vs4-product-alpha-human-package verify-vs4-product-alpha-ux-polish-learn verify-vs4-product-alpha-responsive-mobile verify-vs4-product-alpha-keyboard-focus verify-vs4-product-alpha-ask-readability verify-vs4-product-alpha-decision-pages verify-vs4-product-alpha-ask-injection-boundary verify-vs2-local-range verify-vs2-production-like verify-vs2-security verify-connector-contract-adapter generate-connectorhub-human-gate-artifacts generate-connectorhub-engineering-trail-manifest verify-connectorhub-engineering-trail verify-local-fast
