...
6. Collect usefulness ratings from at least two reviewers, including one non-owner. `usefulness-review.prefilled.json` pins the same current-run ten-Brief sample and leaves ratings and rationale blank.
