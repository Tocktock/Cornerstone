...
38. `docs/scenario-contracts/CONNECTOR_HUB_APPLICATION_CONTRACT.md`
39. `docs/scenario-contracts/CONNECTOR_HUB_APPLICATION_MATRIX.csv`
40. `docs/verification-reports/CONNECTOR_HUB_ENGINEERING_TRAIL_INDEX_2026-06-24.md`
41. `docs/verification-reports/CONNECTOR_HUB_HUMAN_GATES_PREPARATION_REPORT_2026-06-24.md`
...
| `docs/verification-reports/VS2_POLICY_TENANCY_EGRESS_SCENARIO_SPECIFIC_REMEDIATION_REPORT_2026-06-19.md` | Superseded scenario-specific VS2 remediation report; current generated status is 86 PASS, 0 NOT_VERIFIED, 7 HUMAN_REQUIRED |
...
- VS2 policy/tenancy/egress overlay: 93 task-scoped scenarios; verifier path `cornerstone scenario verify vs2-policy-tenancy-egress`; current scenario-specific remediation status is 86 PASS, 0 NOT_VERIFIED, 7 HUMAN_REQUIRED.
...
The VS2 policy, tenant isolation, and default egress-deny contract is in `docs/scenario-contracts/VS2_POLICY_TENANCY_EGRESS_CONTRACT.md` with a machine-readable matrix at `docs/scenario-contracts/VS2_POLICY_TENANCY_EGRESS_MATRIX.csv`. Baseline inventory and implementation notes are in `docs/verification-reports/VS2_POLICY_TENANCY_EGRESS_CURRENT_STATE_2026-06-19.md`; the earlier deterministic proof report is superseded by `docs/verification-reports/VS2_POLICY_TENANCY_EGRESS_SCENARIO_SPECIFIC_REMEDIATION_REPORT_2026-06-19.md`. Current evidence is in `reports/security/vs2-local-security-proof.json`, `reports/security/vs2-scenario-specific-evidence.json`, `reports/security/vs2-synthetic-world.json`, and `reports/scenario/vs2-policy-tenancy-egress-2026-06-19.json`. The native verifier is `cornerstone scenario verify vs2-policy-tenancy-egress --json`; it currently reports 86 PASS, 0 NOT_VERIFIED, and 7 HUMAN_REQUIRED with product feature claims set to `LOCAL_VS2_AI_VERIFIED_HUMAN_GATES_PENDING`. H02-H07 still block production security, real IdP, production network, live provider, human UX, and production-like migration/restore claims.
