...
| `docs/verification-reports/VS2_POLICY_TENANCY_EGRESS_SCENARIO_SPECIFIC_REMEDIATION_REPORT_2026-06-19.md` | Current scenario-specific VS2 remediation report: 7 PASS, 79 NOT_VERIFIED, 7 HUMAN_REQUIRED |
...
- VS2 policy/tenancy/egress overlay: 93 task-scoped scenarios; verifier path `cornerstone scenario verify vs2-policy-tenancy-egress`; current scenario-specific remediation status is 7 PASS, 79 NOT_VERIFIED, 7 HUMAN_REQUIRED.
