...
class ScaffoldCliTests(unittest.TestCase):
    ...
    def test_vs2_h01_approval_package_is_pending_and_non_mutating(self) -> None:
        ...
        self.assertEqual(package["status"], "approved_with_conditions")
        self.assertEqual(package["approval_status"], "approved_with_conditions")
        self.assertTrue(package["sensitive_implementation_allowed"])
        self.assertEqual(package["approval_record"]["decision"], "APPROVE WITH CONDITIONS")
        self.assertFalse(package["approval_record"]["production_claim_allowed"])
